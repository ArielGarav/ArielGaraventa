...
const AboutMe = () => {
  return (
    <AboutTotalContainer>
      ...
      <AboutContainer>
        <AboutParrafo>
          Hello! I'm Ariel Garaventa, a recent graduate of Nucba's Full Stack
          Web Development academy. My journey in programming started with a
          passion for creating and problem-solving, which eventually led me to
          mastering HTML, CSS, JavaScript, TypeScript, and diving deep into the
          world of modern web technologies.
        </AboutParrafo>
        <AboutParrafo>
        ...
        <AboutParrafo>
          ...
          you can find me exploring the latest trends in design and user
          experience, always aiming to improve the visual and interactive
        ...
        <AboutParrafo>
          I'm 22 years old and excited to embark on a full-time career in the
          web development industry. I'm open to new opportunities and
          challenges, and I'm confident that my drive to learn and grow will be
          an asset to any team. Thank you for considering me as a potential
          candidate!
        </AboutParrafo>
      </AboutContainer>
    </AboutTotalContainer>
